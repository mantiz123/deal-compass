...
serve(async (req) => {
  ...
  try {
    ...
    function addFooter(pg: any) {
      ...
      pg.drawText("Generated by PIW Navigator", { x: W - M - bold.widthOfTextAtSize("Generated by PIW Navigator", 7), y: 28, size: 7, font: bold, color: primary });
    }
    ...
    page.drawText("PIW Navigator -- Investment Opportunity", { x: M, y: H - 56, size: 9, font: regular, color: rgb(0.78, 0.92, 0.92) });
    const today = new Date().toLocaleDateString("en-US", { year: "numeric", month: "long", day: "numeric" });
    page.drawText(today, { x: W - M - regular.widthOfTextAtSize(today, 9), y: H - 38, size: 9, font: regular, color: white });

    y = H - 100;

    // --- PIW Score Badge (top right) ---
    ...
    page.drawText(`PIW ${piwScore}%`, { x: badgeX + 10, y: y + 17, size: 14, font: bold, color: white });
